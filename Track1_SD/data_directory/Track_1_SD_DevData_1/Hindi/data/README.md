...
2. Directory contents
    wav     : Contains audio files (*.wav) for different sessions
    rttm    : Contains speaker turns corresponding to the audio segment
                        Format
                        type    rec_id   channel  turn_onset  turn_duration <NA> <NA>  speaker  <NA> <NA>
                        SPEAKER 2006763  1        0.470       0.860         <NA> <NA>  spk0     <NA> <NA>
