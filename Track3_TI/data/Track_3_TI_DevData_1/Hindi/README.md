...
└── Hindi
    ...
    │   └── <Record_ID>.wav
    └── GT
        └── gt_data_topic_identification.csv
```

3. Directory contents
    Audio : Contains audio files (*.wav) for different sessions
    GT    : Contains Record ID of audio files and corresponding medical topics of discussion. 
...
5. GT file description
    ...
    Topics    : Ground truth medical topics discussed in the audio file

    ## Sample GT Data Format
    ```csv
    rec_id,gt_topics
    2006763,"Headache, Leg Pain, Eye Vision"
    2006764,"Weakness, Dizziness, Eye pain, Menstrual pain"
    ```
