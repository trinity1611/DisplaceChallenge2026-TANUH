...
- To run **Track 1 – Speaker Diarization (SD)**, update the `wav` field in the `run.sh` script of the `Track1_SD` system to point to the audio files used for **Track 2 – ASR**, and set the `rttm` field to `None`.
